<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="row gx-3 mb-3">
            ...
            <div class="col-md-2">
                <label class="small mb-1" for="fec_nac">Fecha Nac.</label>
                <input class="form-control" id="fec_nac" name="fec_nac" type="date"
                    placeholder="Ingrese fecha nac." value="{{ old('fec_nac', $presupuestosCab->fec_nac) }}" />
            </div>
            <div class="col-md-12">
