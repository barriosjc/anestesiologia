...
<body>
    ...
    <body>
        ...
        <table class="tabla-header" width="100%" style="border-collapse: collapse; margin-bottom: 20px;">
            ...
            <tr>
                <td>
                    <h3><strong>Presupuesto Nº:</strong> {{ $presupuesto->id }}</h3>
                </td>
            ...
            <tr>
                <td>
                    <h3><strong>Total Presupuesto:</strong>
                        ${{ number_format($presupuesto->presupuestosDet->sum('valor'), 2, ',', '.') }}</h3>
                </td>
                <td>
                    <h3><strong>Total Pagado:</strong>
                        ${{ number_format($presupuesto->pagos->sum('valor'), 2, ',', '.') }}</h3>
                </td>
            </tr>
        </table>
