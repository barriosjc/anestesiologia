                                                ...
                                                <div class="float-right">
                                                    <div class="btn-group btn-group-sm" role="group"
                                                        ...
                                                        <a href="{{ url('/permisos/' . $item->id . '/roles') }}"
                                                            data-bs-toggle="tooltip"
                                                            title="Permisos asignados al rol"><button
                                                                class="btn btn-success btn-sm"><i class="fa fa-key"
                                                                    aria-hidden="true"></i></button></a>
                                                        <button type="button" class="btn btn-primary btn-sm"
                                                            data-bs-toggle="tooltip" title="Modificar permiso"
                                                            wire:click="abrirModalEditar({{ $item->id }})">
                                                            <i class="far fa-edit"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-danger btn-sm"
                                                            data-bs-toggle="tooltip" title="Borrar permiso"
                                                            onclick="confirmDelete({{ $item->id }}, 'Confirma eliminar el permiso?', () => @this.borrar({{ $item->id }}))">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ $modalId ? 'Modificar' : 'Crear' }} permiso</h5>
                ...
                <form wire:submit="guardar" novalidate>
                    <div class="modal-body">
                        <div class="row gx-3 mb-3">
                            <div class="col-md-12">
                                <label class="small mb-1" for="p_name">Nombre</label>
                                <input wire:model="name" class="form-control form-control-sm" id="p_name" type="text"
                        ...
                        <div class="row gx-3 mb-3">
                            <div class="col-md-12">
                                <label class="small mb-1" for="p_guard">Guard name</label>
                                <input wire:model="guard_name" class="form-control form-control-sm" id="p_guard"
