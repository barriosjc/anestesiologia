                            ...
                            <div class="row">
                                    ...
                                    <select class="form-select form-select-sm select2" id="cobertura_id" name="cobertura_id">
                                        ...
                                        @foreach ($coberturas as $item)
                                            <option value="{{ $item->id }}"
                                                {{session('a_cobertura_id') == $item->id ? 'selected' : '' }}>{{ $item->sigla }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-select form-select-sm" id="centro_id" name="centro_id">
                                        ...
                                        @foreach ($centros as $item)
                                            <option value="{{ $item->id }}"
                                                {{ session('a_centro_id') == $item->id ? 'selected' : '' }}>{{ $item->nombre }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select class="form-select form-select-sm" id="profesional_id" name="profesional_id">
                                        ...
                                        @foreach ($profesionales as $item)
                                            <option value="{{ $item->id }}"
                                                {{ session('a_profesional_id') == $item->id ? 'selected' : '' }}>{{ $item->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-md-2">
                                    ...
                                    <select class="form-select form-select-sm" id="estado_id" name="estado_id">
                                        ...
                                        @foreach ($estados as $item)
                                            <option value="{{ $item->id }}"
                                                {{ session('a_estado_id') == $item->id ? 'selected' : '' }}>{{ $item->descripcion }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-2">
                                    ...
                                    <input class="form-control form-control-sm" id="nro_parte"
                                        ...
                                        value="{{ old('nro_parte', session('a_nro_parte')) }}" />
                                </div>
                            </div>
                            <div class="row pt-2">
                                <div class="col-md-2">
                                    ...
                                    <input class="form-control form-control-sm" id="fec_desde" name="fec_desde"
                                        type="date" placeholder="Ingrese fecha desde" value="{{ session('a_fec_desde') }}" />
                                </div>
                                <div class="col-md-2">
                                    ...
                                    <input class="form-control form-control-sm" id="fec_hasta" name="fec_hasta"
                                        type="date" placeholder="Ingrese fecha hasta" value="{{ session('a_fec_hasta') }}" />
                                </div>
                                <div class="form-group col-md-2">
                                    <label class="small mb-1" for="centro_id">Paciente</label>
                                    <input type="text" class="form-control form-control-sm" name="nombre"
                                        value="{{ session('a_nombre') }}" placeholder="Nombre del paciente">
                                </div>
                                <div class="col-md-2">
                                    ...
                                    <input class="form-control form-control-sm" id="fec_desde_adm" name="fec_desde_adm"
                                        type="date" placeholder="Ingrese fecha desde" value="{{ session('a_fec_desde_adm') }}" />
                                </div>
                                <div class="col-md-2">
                                    ...
                                    <input class="form-control form-control-sm" id="fec_hasta_adm" name="fec_hasta_adm"
                                        type="date" placeholder="Ingrese fecha hasta" value="{{ session('a_fec_hasta_adm') }}" />
                                </div>
