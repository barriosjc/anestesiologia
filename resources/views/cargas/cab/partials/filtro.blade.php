    ...
    <form id="reportForm" action="{{ route('partes_cab.filtrar') }}" method='GET'>
        <div class="row">
            <div class="form-group col-md-3">
                ...
                <select class="form-select-sm select2" id="cobertura_id" name="cobertura_id">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" class="form-control form-control-sm" name="nombre"
                    value="{{ old('nombre', session('p_nombre')) }}" placeholder="Nombre del paciente">
            </div>
        </div>
        <div class="row pt-2">
            <div class="form-group col-md-3">
            ...
            <div class="col-md-2">
                ...
                <input class="form-control form-control-sm" id="fec_desde" name="fec_desde" type="date"
                    placeholder="Ingrese fecha desde" value="{{ old('fec_desde', session('p_fec_desde')) }}" />
            </div>
            <div class="col-md-2">
                <label class="small mb-1" for="fec_hasta">Fec. qx hasta</label>
                <input class="form-control form-control-sm" id="fec_hasta" name="fec_hasta" type="date"
                    placeholder="Ingrese fecha hasta" value="{{ old('fec_hasta', session('p_fec_hasta')) }}" />
            </div>
        </div>
        <div class="row pt-2">
            <div class="form-group col-md-3">
            ...
            <div class="col-md-2">
                <label class="small mb-1" for="fec_desde_adm">Fec. carga
                    desde</label>
                <input class="form-control form-control-sm" id="fec_desde_adm" name="fec_desde_adm" type="date"
                    placeholder="Ingrese fecha desde" value="{{ old('fec_desde_adm', session('p_fec_desde_adm')) }}" />
            </div>
            <div class="col-md-2">
                <label class="small mb-1" for="fec_hasta_adm">Fec. carga
                    hasta</label>
                <input class="form-control form-control-sm" id="fec_hasta_adm" name="fec_hasta_adm" type="date"
                    placeholder="Ingrese fecha hasta" value="{{ old('fec_hasta_adm', session('p_fec_hasta_adm')) }}" />
            </div>
            <div class="col-md-2">
                <label class="small mb-1" for="nro_parte">Nro parte</label>
                <input class="form-control form-control-sm" id="nro_parte" name="nro_parte" type="number"
